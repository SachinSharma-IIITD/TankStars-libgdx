...
public class Tank3 implements Screen {
    MyGdxGame game;
    Sound click;
    Texture tank1;
    Texture tank2;
    ...
    public void render(float delta) {
        ...
        game.batch.draw(tank3, -70, 135, 1000, 360);
        game.batch.draw(spectre, 750, 120, 400, 400);
